...
ActiveRecord::Schema[8.0].define(version: 2025_10_12_204828) do
  ...
  create_table "availabilities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["provider_id", "source", "external_id"], name: "index_availabilities_on_provider_id_and_source_and_external_id", unique: true
  ...
  create_table "providers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["source", "external_id"], name: "index_providers_on_source_and_external_id", unique: true
  end
